  ...
  return (
    ...
    >
      ...
      <div
        ...
        className='border-[5px] border-[var(--primary-gray)] rounded-xl lg:h-[85%] xl:h-[53%] 2xl:h-[48%] xl:w-[85%] lg:w-[85%] 2xl:w-[80%] flex justify-center items-center'
      >
        ...
        <div className='flex flex-col h-full justify-between w-[90%]'>
          <div className='flex  flex-col items-center justify-center h-full'>
            ...
            <div className='  xl:w-[99%] lg:w-[99%] 3xl:w-[90%] h-auto flex lg:gap-[1.286rem] xl:gap-6 flex-wrap items-center justify-center mt-8'>
              <Skill name='GIT' />
              <Skill name='Figma' />
              <Skill name='Docker' />
